...
Route::name('admin.')->prefix('admin')->middleware('admin')->group(function () {
    ...
    Route::controller(\App\Http\Controllers\Admin\AiStudioController::class)->group(function () {
        Route::get('ai-studio', 'index')->name('ai.studio');
        Route::post('ai-studio/generate', 'generate')->name('ai.studio.generate');
        Route::post('ai-studio/refresh-heygen', 'refreshHeygen')->name('ai.studio.refresh.heygen');
        Route::post('ai-studio/fix-audio', 'fixAudio')->name('ai.studio.fix.audio');
    });

    Route::controller(\App\Http\Controllers\Admin\LessonStudioController::class)->group(function () {
        Route::get('course/{course}/lesson-studio', 'show')->name('lesson.studio');
        Route::post('course/{course}/lesson-studio/settings', 'saveSettings')->name('lesson.studio.settings');
        Route::post('course/{course}/lesson-studio/generate', 'generateCurriculum')->name('lesson.studio.generate');
        Route::post('course/{course}/lesson-studio/pdf', 'storePdf')->name('lesson.studio.pdf');
        Route::post('course/{course}/lesson-studio/text', 'storeText')->name('lesson.studio.text');
        Route::post('course/{course}/lesson-studio/refresh-heygen', 'refreshHeygen')->name('lesson.studio.refresh.heygen');
        Route::post('course/{course}/lesson-studio/lesson/{lesson}/regenerate-video', 'regenerateLessonVideo')->name('lesson.studio.regenerate.video');
        Route::post('course/{course}/lesson-studio/lesson/{lesson}/fix-audio', 'fixLessonAudio')->name('lesson.studio.fix.audio');
    });
    ...
    Route::controller(\App\Http\Controllers\Admin\AiCourseGeneratorController::class)->group(function () {
        Route::post('course/ai-generate', 'generate')->name('course.ai.generate');
    });
