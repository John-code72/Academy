...
use App\Http\Controllers\student\PersonalizedCourseController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::controller(QuizController::class)->group(function () {
        Route::get('practice-tests', 'index_practice_tests')->name('practice.tests.index');
        Route::get('practice-test/{id}', 'show_practice_test')->name('practice.test.show');
        Route::post('practice-test/upload-recording', 'upload_practice_recording')->name('practice.test.upload.recording');
    ...
    // personalized AI-generated courses
    Route::controller(PersonalizedCourseController::class)->group(function () {
        Route::get('my-personalized-courses', 'index')->name('personalized.course.index');
        Route::post('my-personalized-courses/generate', 'generate')->name('personalized.course.generate');
        Route::get('my-personalized-courses/{slug}', 'show')->name('personalized.course.show');
        Route::get('my-personalized-courses/{slug}/lesson/{lesson_id}', 'lesson')->name('personalized.course.lesson');
        Route::get('my-personalized-courses/{slug}/lesson/{lesson_id}/video-status', 'checkVideo')->name('personalized.course.lesson.video.status');
        Route::post('my-personalized-courses/{slug}/lesson/{lesson_id}/regenerate-video', 'regenerateVideo')->name('personalized.course.lesson.video.regenerate');
    });
