...
<style>
    ...
    .offcanvas.offcanvas-start {
        --font-family: "Poppins", sans-serif;
        --bg-white: #fff;
        --text-color:rgb(214, 213, 213);
        --color-white: #fff;
        --color-1: rgba(45, 66, 129, 1);
        --color-2: #192335;
        --color-black: #000;
    ...
    /* Start main header */
    .header-area {
        background-color:rgba(45, 66, 129, 1);
    }
    ...
    /* Hero university — fond (custom_style.css définit aussi la couleur) */
    .lms-banner-section4 {
        background-color: rgba(45, 66, 129, 1) !important;
    }

    .lms-banner-section4::after {
        background: rgba(45, 66, 129, 1) !important;
    }

    /* Orange uniquement : bouton du bandeau hero (pas les autres .btn-danger-1) */
    .lms-banner-section4 .btn-danger-1 {
        background: #ec9a29;
        color: #fff !important;
    }

    .lms-banner-section4 .btn-danger-1:active,
    .lms-banner-section4 .btn-danger-1:hover {
        background: #d48218 !important;
        color: #fff !important;
    }

    /* End main header */
</style>
<section class="lms-banner-section4" style="background-color: rgba(45, 66, 129, 1);">
    <div class="container">
                                        ...
                                        <div class="scale-single-slide">
                                            <div class="lms-video">
                                                ...
                                                @else
                                                    ...
                                                    <video src="{{asset('assets/global/video/banner.mp4'')}}" controls></video>
                                                </div>
                                                @endif
                                            </div>
                                        </div>
