<div class="w-100">
    ...
    <div class="mb-3 d-flex gap-2 align-items-center flex-wrap">
        ...
        @if ($sections->count() > 0)
            ...
            <a href="#" onclick="ajaxModal('{{ route('modal', ['instructor.quiz.practice_test_create', 'id' => $course_details->id]) }}', '{{ get_phrase('Add Defrilex onboarding Test') }}')" class="btn ol-btn-light ol-btn-sm">{{ get_phrase('Add Defrilex onboarding Test') }}</a>
                                ...
                                <li>
                                    ...
                                    <div class="buttons">
                                        @if (in_array($lesson->lesson_type, ['quiz', 'practice_test']))
                                            ...
                                            <a href="#" data-bs-toggle="tooltip" title="{{ $lesson->lesson_type == 'practice_test' ? get_phrase('Edit Defrilex onboarding Test') : get_phrase('Edit quiz') }}" onclick="ajaxModal('{{ route('modal', ['instructor.quiz.edit', 'id' => $lesson->id]) }}', '{{ $lesson->lesson_type == 'practice_test' ? get_phrase('Edit Defrilex onboarding Test') : get_phrase('Edit quiz') }}')" class="edit-delete">
                                                <span class="fi-rr-pencil"></span>
                                            </a>
                                        @endif
