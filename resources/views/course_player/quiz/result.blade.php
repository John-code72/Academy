...
<div class="result">
    ...
    @if (count($wrong_answers) > 0)
        <div class="mb-4 p-3 border rounded" style="background:#f0f7ff;border-color:#bfdbfe!important;">
            <h5 class="mb-2">{{ get_phrase('Want to improve?') }}</h5>
            <p class="mb-3 text-muted">
                {{ get_phrase('Generate a short personalized course built from the topics you missed in this quiz.') }}
            </p>
