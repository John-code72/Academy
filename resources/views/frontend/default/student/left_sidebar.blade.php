    ...
    <div class="gradient-border">
        <div class="course-sideBar">
            ...
            <ul class="couses-tab-list">
                ...
                <li class="@if ($current_route == 'practice.tests.index' || $current_route == 'practice.test.show') active @endif">
                    <a href="{{ route('practice.tests.index') }}">
                        <i class="fa-solid fa-graduation-cap text-23px me-3 ms-1"></i>
                        {{ get_phrase('Defrilex onboarding Test') }}
                    </a>
                </li>

                @if (app(\App\Services\GeminiVisionChatService::class)->isConfigured())
                    <li class="@if ($current_route == 'ai.assistant.page') active @endif">
                        <a href="{{ route('ai.assistant.page') }}">
                            <i class="fi-rr-comment-alt text-23px me-3 ms-1"></i>
                            {{ ai_assistant_name() }}
                        </a>
                    </li>
                @endif
