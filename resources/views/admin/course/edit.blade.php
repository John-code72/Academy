...
@section('content')
    ...
    <div class="col-md-12">
        @php
            ...
            $tab = request('tab');
            $isCurriculumTab = in_array($tab, ['curriculum', '', null], true);
        @endphp
        @if (!$isCurriculumTab)
                    ...
                    <div class="row mb-3">
                        ...
                        @if (!$isCurriculumTab)
                            <div class="col-sm-4 mt-3 mt-sm-0 d-flex justify-content-start justify-content-sm-end">
                                <button type="submit" class="btn ol-btn-outline-secondary @if (request('tab') == 'live-class' || request('tab') == 'assignment') d-none @endif">
