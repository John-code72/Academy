    ...
    <nav class="sidebar-nav">
        <ul class="px-14px pb-24px">
            ...
            @if (has_permission('admin.courses'))
                <li class="sidebar-first-li first-li-have-sub @if ($current_route == 'admin.courses' || $current_route == 'admin.course.create' || $current_route == 'admin.course.edit' || $current_route == 'admin.coupons' || $current_route == 'admin.ai.studio' || $current_route == 'admin.lesson.studio') active showMenu @endif">
                    ...
                    <ul class="first-sub-menu">
                        ...
                        <li class="sidebar-second-li @if ($current_route == 'admin.ai.studio' || $current_route == 'admin.lesson.studio') active @endif">
                            <a href="{{ route('admin.ai.studio') }}">{{ get_phrase('AI Studio') }}</a>
                        </li>
                    </ul>
                </li>
            @endif
