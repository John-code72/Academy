...
class OpenAiController extends Controller
{
    ...
    function settings_update(Request $request)
    {
        $validated = $request->validate([
            ...
            'deepseek_api_key' => 'nullable|max:255',
            'deepseek_model' => 'nullable|in:deepseek-chat,deepseek-reasoner',
            'youtube_api_key' => 'nullable|max:255',
            'heygen_api_key' => 'nullable|max:255',
            'heygen_avatar_id' => 'nullable|max:255',
            'heygen_voice_id' => 'nullable|max:255',
        ]);

        foreach ($request->except(['_token']) as $type => $value) {
